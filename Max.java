...
public class Max
{
    ...
    private static int MaxVerticale(Grille g,Case a){
      ...
      for(int i=g.getTab().length-1;i>g.getTab().length-4;i--){
            for(int j=0;j<g.getTab()[i].length;j++){
                if(g.getTab()[i][j]== 
                a && g.getTab()[i-1][j]==Case.VIDE  && g.getTab()[i-2][j]==Case.VIDE && g.getTab()[i-3][j]==Case.VIDE) max1=1;
                if(g.getTab()[i][j]== a && g.getTab()[i-1][j]==a  && g.getTab()[i-2][j]==Case.VIDE && g.getTab()[i-3][j]==Case.VIDE ) max2=2  ;
                if(g.getTab()[i][j]== a && g.getTab()[i-1][j]==a  && g.getTab()[i-2][j]==a && g.getTab()[i-3][j] ==Case.VIDE ) max3=50  ;
                if(g.getTab()[i][j]== a && g.getTab()[i-1][j]== a && g.getTab()[i-2][j]== a && g.getTab()[i-3][j] == a) max4=10000  ; 
            }
        }
    ...
    private static int MaxHorizontale(Grille g,Case a){
        ...
        for(int i=0;i<g.getTab().length;i++){
            for(int j=0;j<g.getTab()[i].length-3;j++){
                ...
                if(g.getTab()[i][j]== a && g.getTab()[i][j+1]==a  && g.getTab()[i][j+2]== a && g.getTab()[i][j+3]==Case.VIDE )  max3=50  ;
                if(g.getTab()[i][j]== a && g.getTab()[i][j+1]== a && g.getTab()[i][j+2]== a && g.getTab()[i][j+3] == a) max4=10000  ;
    ...
    private static int MaxDiagonaleAv(Grille g,Case a){
      ...
      for(int i=g.getTab().length-1;i>g.getTab().length-4;i--){
            for(int j=0;j<g.getTab()[i].length-3;j++){
                ...
                if(g.getTab()[i][j]== a && g.getTab()[i-1][j+1]==a  && g.getTab()[i-2][j+2]==a && g.getTab()[i-3][j+3]==Case.VIDE )  max3=50  ;
                if(g.getTab()[i][j]== a && g.getTab()[i-1][j+1]== a && g.getTab()[i-2][j+2]== a && g.getTab()[i-3][j+3]== a ) max4=10000  ;
    ...
    public static int Max1(Grille g,Case a){
